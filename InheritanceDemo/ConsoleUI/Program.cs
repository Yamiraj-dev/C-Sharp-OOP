namespace ConsoleUI
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Phone phone = new Smartphone(); // a child class should always be able fill in for the parent class.

            List<Phone> phones = new List<Phone>();

            phones.Add(new Cellphone());
            phones.Add(new Smartphone());
            // if we added hotspot if it was inheriting from phone. A for each loop would crash this
